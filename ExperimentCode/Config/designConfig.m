...
if const.staircasemode > 0
    ...
    expDes.itiDur_s  = 0.01; %.8;      % 2 inter-trial interval (fixation)
    expDes.NumBlocks = 5;
else
    expDes.stimDur_s  = .01; %1; %.3;   % 0.5 sec stimulus duration
    expDes.itiDur_s  = 0.01; %.8; %.8;      % 2 inter-trial interval (fixation)
    expDes.NumBlocks = 1;
end
